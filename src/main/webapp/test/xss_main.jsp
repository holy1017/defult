...
<body>
	<div class="hint" id="div">
		<form action="xss_test1.jsp" id="form1" method="post">
			xss_test1.jsp <br /> <input type="text" name="data" id="data1" size="50" value="&lt;script&gt;alert('xss')&lt;/script&gt;"/> <input
				type="submit" value="run" />
			&lt;script&gt;alert("xss")&lt;/script&gt; 라고 입력하기

		</form>
		<form action="xss_test2.jsp" id="form1" method="post">
			xss_test2.jsp <br /> <input type="text" name="data" id="data1" size="50" value="1" /> <input
				type="submit" value="run" /> <label for="">입력값 1or2</label>
		</form>
		<form action="xss_test3.jsp" id="form1" method="post">
			xss_test3.jsp <br /> <input type="text" name="data" id="data1" size="50" value="&lt;script&gt;alert('xss')&lt;/script&gt;" /> <input
				type="submit" value="run" />
			&lt;script&gt;alert("xss")&lt;/script&gt;
		</form>
		<form action="xss_test4.jsp" id="form1" method="post">
			xss_test4.jsp <br /> <input type="text" name="data" id="data1" size="50" value="&lt;script&gt;alert('xss')&lt;/script&gt;" /> <input
				type="submit" value="run" />
			&lt;script&gt;alert("xss")&lt;/script&gt;
		</form>
		<form action="xss_test4.jsp" id="form1" method="post">
